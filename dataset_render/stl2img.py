...
#when your ready to put the material paramter put this below 'material=None'.
    def __init__(self, paths=None, dimensions=None, image_format=None, verbose=False,
        ...
        :param card_coords: the positions of sommits of a 3D cube
        """
...
class JobTemplate(object):
    ...
    def get_output_path(self, input_filepath, exec_time=None, i='0'):
        """
...
def tracking_camera(position=(10,10,10), camera_name='Camera'):
    ...
    # Calculate rotation quaternion from the direction
