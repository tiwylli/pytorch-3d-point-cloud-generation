# Uncomment to train chairs
#python3 train_stg1.py --model ORIG_STG1 --experiment 1k_adam_trueWD \
#	--endEpoch 1000 \
...
#Thingi10k dataset
#python3 train_stg1.py --model ORIG_STG1 --experiment lc_thingi10k \
#	--endEpoch 1000 \
#	--chunkSize 100 --batchSize 100 \
#	--optim adam --trueWD 1e-4 --lr 5e-3 \
#	--saveEpoch 100 \
...
python3 train_stg1.py --model ORIG_STG1 --experiment adrienThingi10k \
	--endEpoch 1000 \
	--chunkSize 100 --batchSize 100 \
	--optim adam --trueWD 1e-4 --lr 5e-3 \
	--saveEpoch 100 \
